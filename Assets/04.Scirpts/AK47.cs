...
public class AK47 : WeaponBase
{
    ...
    public AudioClip audioClipTakeOutReloadWeapon;//Ak47 처음 장전 사운드
    ...
    private void OnEnable()
    {
        ...
        audioSource.PlayOneShot(audioClipTakeOutReloadWeapon); //Ak47 처음 장전 사운드
    ...
    {
        if (type == 0 && isReload == false) //마우스 왼쪽 클릭, 재장전 중이 아니라면
        {
    ...
    private IEnumerator OnMuzzleFlashEffect() //코루틴 메소드
    {
        muzzleFlashEffect.SetActive(true);

        // 무기 공격속도보다 빠르게 이펙트 활성화
